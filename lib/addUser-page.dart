...
class _AddUserState extends State<AddUser> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
          title: Text('Nuevo Usuario',style: new TextStyle(fontFamily: 'Nunito',color: Colors.black),),
      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text('Agregar Usuario',style: TextStyle(color: Colors.blue,fontSize: 30.0),textAlign: TextAlign.center,),
          ),
          Padding(
